...
class PDBWriter:
    ...
    def _write_conect_records(self,
        ...
        if not struct.conect_data:
            ...
            # Warn the user that there are no connectivity
            # data
            warnstr = \
    ...
    def _write_ssbond_records(self,
        ...
        # Get the format strings for the SSBOND records
        ...
        for mod in struct.conect_data:
            ...
            for atom1, rec \
                ...
                # Get the atom's chain ID and residue's number,
                ...
                for atom2, data in rec.items():
                    ...
                    # Get the first atom's symmetry operator
                    atom1_symop = data["ptnr1_symmetry"]

                    # Get the second atom's symmetry operator
